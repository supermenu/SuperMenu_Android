...
public class ConnectionPool {
    ...
    private static final String TAG = "ConnectionPoolLog";
...
// 它中存放的对象为 PooledConnection 型
     ...
     * @param initialConnections int 用于设置初始连接池中连接的数量
    ...
    /**
     * 设置连接池自动增加的大小
     * @param incrementalConnections int 连接池自动增加的大小
     */
     ...
     * @param maxConnections int 设置连接池中最大可用的连接数量值
        ...
        for (int x = 0; x < numConnections; x++) {
            ...
            try{
               ...
               // System.out.println(" 创建数据库连接失败！ "+e.getMessage());
                Log.e(TAG," 创建数据库连接失败！ "+e.getMessage());
     ...
     * 关闭一个数据库连接
     *
     * @param conn Connection 需要关闭的数据库连接
     *
     */
    ...
    private void closeConnection(Connection conn) {
        ...
        try {
            ...
            Log.v(TAG,"关闭数据库连接出错： "+e.getMessage());
